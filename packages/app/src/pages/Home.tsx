      ...
      >
        <VStack mt={20} spacing={10} h="full" w="full" alignItems="flex-start">
          ...
          <VStack width="100%">
            <Text pb={4}>
              {t(
                "You can play a fundamental role as a part of the ETHDam community, both in supporting the local community, and in exploring new ways to finance public goods through quadratic voting."
              )}
            </Text>
            <Text pb={4} w={"full"}>
              {t(
                "During the venue, our ETHDam team will send you an email with a password. This is the “MACI” key you’ll use to vote."
              )}
            </Text>
            <Text pb={4} w={"full"}>
              {t(
                ...
                <AccordionItem border="none" w={"full"}>
                  ...
                  <AccordionPanel pb={4}>
                    <Text fontSize="sm" pb={8}>
                      {t(
                        "All ETHDam attendees will receive an email with a MACI key."
                      )}
                    </Text>
                    <Text fontSize="sm" pb={8}>
                      {t(
                    ...
                    <Text fontSize="sm" pb={8}>
                      {t(
                        "Voting is pseudo-anonymous, but to record the vote, your MACI key will be sent to your email address by the ETHDam team."
                      )}
                    </Text>
                    <Text fontSize="sm" pb={8}>
                      {t(
                    ...
                    <Text fontSize="sm" pb={8}>
                      {t(
                        "If you have any questions, please, feel free to ask any of the ETHDam volunteers."
                      )}
                    </Text>
                  </AccordionPanel>
                </AccordionItem>
